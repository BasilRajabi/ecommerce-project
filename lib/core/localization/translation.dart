...
class MyTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "ar": {
          "-5" : "ادخل الرمز الذي وصلك على البريد الالكتروني",
          "-4" : "تأكيد البريد الالكتروني",
          "-3" : "رمز التأكيد",
          "-2" : "تستطيع تسجيل الدخول الان",
          "-1" : "تأكيد كلمة المرور",
          "0" : "تغيير كلمة المرور",
          "1": "اختر اللغة",
          "2": "اختر المنتجة",
        ...
        "en": {
          "-5" : "Enter The Verification Code Sent To basilrajabi@gmail.com",
          "-4" : "Verify Your Email",
          "-3" : "Verification Code",
